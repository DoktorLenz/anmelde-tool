...
import de.stinner.anmeldetoolbackend.domain.auth.persistence.ResetPasswordEntity;
import de.stinner.anmeldetoolbackend.domain.auth.persistence.ResetPasswordRepository;
