...
import dev.stinner.scoutventure.domain.error.ErrorResponseBuilder;
import dev.stinner.scoutventure.domain.error.ExceptionHandlerHelper;
import dev.stinner.scoutventure.domain.exceptions.nami.NamiAccessViolationException;
import dev.stinner.scoutventure.domain.exceptions.nami.NamiLoginFailedException;
