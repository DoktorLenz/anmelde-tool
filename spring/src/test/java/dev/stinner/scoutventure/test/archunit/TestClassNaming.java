...
@AnalyzeClasses(packages = "dev.stinner.scoutventure", importOptions = ImportOption.OnlyIncludeTests.class)
class TestClassNaming {
    ...
    static final ArchRule UNIT_TESTS =
            classes()
                    ...
                    .and().resideOutsideOfPackage("dev.stinner.scoutventure.test.archunit")
