...
import de.stinner.anmeldetool.application.rest.logging.LoggingConfiguration;
...
class LoggingConfigurationTest {
    ...
    void shouldNotLogRequestToActuatorLiveness(CapturedOutput output) {
        ...
        request.setRequestURI(RestActuatorEndpoints.LIVENESS);
    ...
    void shouldNotLogRequestToActuatorReadiness(CapturedOutput output) {
        ...
        request.setRequestURI(RestActuatorEndpoints.READINESS);
